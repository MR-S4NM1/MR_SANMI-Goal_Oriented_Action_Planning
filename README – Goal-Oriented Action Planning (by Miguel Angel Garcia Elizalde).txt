...
├── Scripts/
│   ├── Core/
│   │   ├── WorldState.cs           # Shared world state with event system
│   │   ├── GlobalWorldState.cs     # Singleton state manager
│   │   ├── GOAPGoal.cs             # Goal definition with priority
│   │   ├── GOAPPlanner.cs          # Heuristic planning algorithm
│   │   ├── GOAPAction.cs           # Abstract action base class
│   │   └── GOAPAgent.cs            # Base agent with state machine
│   │
│   ├── States/
│   │   ├── IAgentState.cs          # State interface
│   │   ├── IdleState.cs            # Waiting state
│   │   ├── PlanningState.cs        # Goal evaluation and planning
│   │   ├── ExecutingPlanState.cs   # Action execution
│   │   └── ReplanningState.cs      # Forced replanning transition
│   │
│   ├── Agents/
│   │   ├── GOAPAgent_Guard.cs      # Law enforcement AI
│   │   ├── GOAPAgent_Sorceress.cs  # Magic user and crafter AI
│   │   └── GOAPAgent_Thief.cs      # Stealth and survival AI
│   │
│   ├── Actions/
│   │   ├── Common/
│   │   │   └── AGoToPosition.cs    # Base movement action
│   │   ├── Guard/
│   │   │   ├── APatrol.cs          # Waypoint patrol
│   │   │   ├── AAGoAfterTheThief_Guard.cs  # Pursuit movement
│   │   │   └── AApprehendThief_Guard.cs    # Physical capture
│   │   ├── Sorceress/
│   │   │   ├── AGetPlants.cs       # Resource navigation
│   │   │   ├── ACollectPlants.cs   # Resource gathering
│   │   │   ├── AGoToPreparePotions.cs      # Crafting navigation
│   │   │   ├── APreparePotions.cs  # Potion brewing
│   │   │   ├── AAGoAfterTheThief_Sorceress.cs  # Magical pursuit
│   │   │   └── AAprehend_Sorceress.cs      # Spellcasting capture
│   │   └── Thief/
│   │       ├── AGoToSteal.cs       # Theft navigation
│   │       ├── AStealItem.cs       # Item stealing
│   │       ├── AFlee.cs            # Escape with contingency
│   │       └── ACaught.cs          # Death handling
│   │
│   └── Animations /
│       └── AnimationsManager.cs    # Animation controller interface
│
│
├── README.md
└── LICENSE
...
7. Survival Behavior – Thief demonstrates priority-based survival instincts
